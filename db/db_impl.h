...
class DBImpl : public DB {
 ...
 private:
  ...
  Env* const env_;  //负责所有I/O操作
  const InternalKeyComparator internal_comparator_; //比较器
  ...
  TableCache* const table_cache_; //SSTable查询缓存
  ...
  // Queue of writers.
  std::deque<Writer*> writers_ GUARDED_BY(mutex_);  //写入操作的双端队列
  WriteBatch* tmp_batch_ GUARDED_BY(mutex_);  //多个batch合并成的临时大batch
